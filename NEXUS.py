...
Run:
    python NEXUS_OMNI_NEXUS_GUARDIAN_363_ONE_FILE.py
Open:
    http://127.0.0.1:8787
...
APP_NAME = "NEXUS — AI TRADING WORKSPACE"
...
BUILD_ID = "11.3-nexus-clean-branding"
...
<title>NEXUS — AI Trading Workspace</title>
<style>
:root{--bg:#070707;--panel:#101010;--panel2:#171717;--line:#2b2b2b;--text:#f5f5f5;--muted:#a1a1aa;--g:#f4f4f5;--g2:#d4d4d8;--r:#ff6572;--a:#ffc857;--b:#6fa8ff;--shadow:0 28px 90px rgba(0,0,0,.47)}*{box-sizing:border-box}html{scroll-behavior:smooth;background:var(--bg)}body{margin:0;color:var(--text);font-family:Inter,ui-sans-serif,system-ui,-apple-system,Segoe UI,Roboto,sans-serif;background:radial-gradient(circle at 85% -10%,rgba(255,255,255,.035),transparent 30%),radial-gradient(circle at -10% 70%,rgba(255,255,255,.018),transparent 28%),var(--bg)}body:before{content:"";position:fixed;inset:0;pointer-events:none;opacity:.16;background-image:linear-gradient(rgba(255,255,255,.035) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.035) 1px,transparent 1px);background-size:44px 44px;mask-image:linear-gradient(to bottom,black,transparent 92%)}button,input{font:inherit}.app{display:grid;grid-template-columns:250px minmax(0,1fr);min-height:100vh}.sidebar{position:sticky;top:0;height:100vh;border-right:1px solid var(--line);padding:24px 17px;background:rgba(6,10,7,.86);backdrop-filter:blur(18px);z-index:30}.logo{display:flex;gap:12px;align-items:center;padding:2px 7px 28px}.mark{width:40px;height:40px;border:1px solid var(--g);border-radius:13px;display:grid;place-items:center;font-weight:950;color:var(--g);box-shadow:0 0 32px rgba(255,255,255,.16)}.logo h1{font-size:14px;letter-spacing:2px;margin:0}.logo small{display:block;color:var(--muted);font-size:9px;letter-spacing:1.3px;margin-top:3px}.nav{display:grid;gap:5px}.nav button{all:unset;cursor:pointer;padding:12px 13px;border-radius:11px;color:var(--muted);display:flex;align-items:center;gap:10px;font-size:12px;transition:.2s}.nav button:hover,.nav button.active{background:#1b1b1b;color:var(--text)}.nav i{width:8px;height:8px;border:1px solid #666666;border-radius:50%}.nav .active i{background:var(--g);border-color:var(--g);box-shadow:0 0 13px var(--g)}.side-status{position:absolute;left:17px;right:17px;bottom:20px;border:1px solid var(--line);border-radius:15px;background:#111111;padding:14px}.side-row{display:flex;justify-content:space-between;font-size:10px}.dot{width:8px;height:8px;border-radius:50%;display:inline-block;background:var(--g);box-shadow:0 0 12px var(--g);margin-right:7px}.tiny{font-size:9px;line-height:1.55;color:var(--muted)}main{min-width:0;padding:24px 28px 60px}.top{display:flex;justify-content:space-between;align-items:center;gap:18px;margin-bottom:22px}.title h2{font-size:25px;letter-spacing:-.7px;margin:0 0 5px}.title p{margin:0;color:var(--muted);font-size:11px}.top-actions{display:flex;gap:8px;align-items:center;justify-content:flex-end;flex-wrap:wrap}.btn{border:1px solid var(--line);background:#181818;color:var(--text);padding:10px 13px;border-radius:10px;cursor:pointer;font-size:11px;font-weight:800;transition:.2s}.btn:hover{transform:translateY(-1px);border-color:#707070}.btn.green{background:var(--g);color:#061008;border-color:var(--g)}.btn.red{background:#2a1114;color:#ffadb4;border-color:#622931}.btn.amber{background:#20190b;color:#ffe09d;border-color:#66501e}.btn.blue{background:#101827;color:#b9d1ff;border-color:#2a4773}.btn:disabled{opacity:.42;cursor:not-allowed;transform:none}.pill{border:1px solid var(--line);border-radius:999px;padding:9px 12px;color:var(--muted);font-size:10px;white-space:nowrap}.metrics{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:10px;margin-bottom:11px}.card{border:1px solid var(--line);background:linear-gradient(145deg,rgba(17,24,19,.94),rgba(8,12,10,.94));border-radius:16px;box-shadow:var(--shadow)}.metric{padding:15px;min-height:101px;position:relative;overflow:hidden}.metric:after{content:"";position:absolute;width:82px;height:82px;border:1px solid rgba(117,255,157,.07);border-radius:50%;right:-27px;top:-27px}.label{font-size:9px;letter-spacing:1.2px;text-transform:uppercase;color:var(--muted)}.value{font-size:23px;font-weight:850;letter-spacing:-.9px;margin-top:13px}.sub{font-size:9px;color:var(--muted);margin-top:6px}.positive{color:var(--g)!important}.negative{color:var(--r)!important}.amberText{color:var(--a)!important}.layout{display:grid;grid-template-columns:minmax(0,1.55fr) minmax(340px,.78fr);gap:11px}.stack{display:grid;gap:11px;align-content:start}.panel-head{display:flex;justify-content:space-between;align-items:center;gap:12px;padding:14px 15px;border-bottom:1px solid var(--line)}.panel-head h3{font-size:11px;letter-spacing:.9px;text-transform:uppercase;margin:0}.panel-head span{font-size:9px;color:var(--muted)}.symbol-tools{display:flex;gap:7px}.symbol-input{width:82px;background:#0f0f0f;color:var(--text);border:1px solid var(--line);border-radius:9px;padding:8px 9px;font-weight:800;outline:none}.chart-card{min-height:370px}.chart-wrap{height:306px;padding:11px 14px 4px;position:relative}.chart-wrap canvas{width:100%;height:100%;display:block}.chart-overlay{position:absolute;left:23px;top:20px;pointer-events:none}.chart-price{font-size:27px;font-weight:900;letter-spacing:-1px}.chart-change{font-size:10px;margin-top:4px}.ai-card{padding:16px;position:relative;overflow:hidden}.ai-card:before{content:"";position:absolute;inset:-50%;background:conic-gradient(from 10deg,transparent,rgba(75,255,130,.05),transparent 28%);animation:spin 15s linear infinite}@keyframes spin{to{transform:rotate(360deg)}}.ai-inner{position:relative;z-index:2}.orb{width:86px;height:86px;margin:10px auto 13px;border-radius:50%;display:grid;place-items:center;background:radial-gradient(circle at 40% 35%,#c4ffd2,#4ff384 24%,#0b321a 57%,#061008 72%);box-shadow:0 0 48px rgba(75,255,132,.3),inset 0 0 20px rgba(255,255,255,.14);animation:pulse 2.5s ease-in-out infinite}.orb:after{content:"AI";font-size:22px;font-weight:950;color:#061008}@keyframes pulse{50%{transform:scale(1.035);box-shadow:0 0 68px rgba(75,255,132,.4),inset 0 0 20px rgba(255,255,255,.14)}}.ai-title{text-align:center}.ai-title strong{display:block;font-size:14px}.ai-title span{font-size:9px;color:var(--muted)}.decision{margin-top:14px;border:1px solid var(--line);background:rgba(4,8,5,.72);border-radius:13px;padding:12px}.decision-top{display:flex;justify-content:space-between;align-items:center}.action{font-size:20px;font-weight:950}.confidence{font-size:10px;color:var(--muted)}.thesis{font-size:10px;color:#a6b9ac;line-height:1.55;margin:10px 0}.levels{display:grid;grid-template-columns:repeat(3,1fr);gap:6px}.level{background:#181818;border-radius:8px;padding:8px}.level b{display:block;margin-top:4px;font-size:10px}.ai-buttons{display:grid;grid-template-columns:1fr 1fr;gap:7px;margin-top:9px}.committee{margin-top:12px;display:grid;gap:7px}.vote{display:grid;grid-template-columns:94px 1fr 38px;gap:7px;align-items:center;font-size:9px}.bar{height:7px;background:#172019;border-radius:99px;overflow:hidden;position:relative}.bar span{position:absolute;top:0;bottom:0;left:50%;width:0;background:var(--g);border-radius:99px;transition:.5s}.vote em{font-style:normal;text-align:right;color:var(--muted)}.table-card{overflow:hidden}.table-scroll{overflow:auto;max-height:340px}table{width:100%;border-collapse:collapse;font-size:10px;white-space:nowrap}th{position:sticky;top:0;z-index:2;background:#0e1410;text-align:left;padding:10px 13px;color:var(--muted);font-size:8px;letter-spacing:1px;text-transform:uppercase;border-bottom:1px solid var(--line)}td{padding:11px 13px;border-bottom:1px solid rgba(32,49,40,.65)}tbody tr{cursor:pointer}tbody tr:hover td{background:rgba(255,255,255,.025)}.sym{font-weight:850}.badge{display:inline-block;border-radius:999px;padding:4px 7px;font-size:8px;font-weight:900}.badge.buy{background:rgba(255,255,255,.10);color:var(--g)}.badge.exit{background:rgba(255,101,114,.13);color:#ff929c}.badge.hold{background:rgba(255,200,87,.10);color:#ffd77d}.empty{padding:24px!important;text-align:center;color:var(--muted)}.guard-grid{padding:13px;display:grid;grid-template-columns:repeat(2,1fr);gap:7px}.guard{border:1px solid var(--line);border-radius:10px;padding:9px;background:#121212}.guard b{font-size:9px;display:block}.guard span{font-size:8px;color:var(--muted);display:block;margin-top:4px;line-height:1.35}.guard.pass b{color:var(--g)}.guard.fail{border-color:#5b2930}.guard.fail b{color:var(--r)}.backtest-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:7px;padding:13px}.bt-metric{background:#121212;border:1px solid var(--line);border-radius:10px;padding:10px}.bt-metric b{display:block;font-size:13px;margin-top:5px}.bt-chart{height:145px;padding:0 13px 12px}.bt-chart canvas{width:100%;height:100%}.news-list{max-height:300px;overflow:auto}.news{padding:11px 13px;border-bottom:1px solid rgba(32,49,40,.65)}.news b{font-size:10px;line-height:1.4;display:block}.news span{font-size:8px;color:var(--muted);margin-top:5px;display:block}.settings{display:grid;grid-template-columns:repeat(2,1fr);gap:9px;padding:13px}.field label{font-size:8px;letter-spacing:.9px;text-transform:uppercase;color:var(--muted);display:block;margin-bottom:5px}.field input{width:100%;border:1px solid var(--line);border-radius:9px;background:#0d0d0d;color:var(--text);padding:9px;outline:none}.full{grid-column:1/-1}.toggle{display:flex;justify-content:space-between;align-items:center;border:1px solid var(--line);border-radius:9px;padding:8px 10px;background:#0d0d0d}.toggle input{width:auto}.warning{margin:0 13px 13px;border:1px solid #5b481e;background:#1b150a;color:#d8c17d;border-radius:10px;padding:10px;font-size:9px;line-height:1.5}.log{display:grid;grid-template-columns:70px 52px 1fr;gap:7px;padding:9px 12px;border-bottom:1px solid rgba(32,49,40,.58);font-size:9px}.log time,.log em{color:var(--muted);font-style:normal}.intel-grid{display:grid;grid-template-columns:repeat(6,1fr);gap:7px;padding:13px}.intel{background:#121212;border:1px solid var(--line);border-radius:10px;padding:10px;min-width:0}.intel b{display:block;font-size:13px;margin-top:5px;overflow:hidden;text-overflow:ellipsis}.stress-list{padding:0 13px 13px;display:grid;grid-template-columns:repeat(3,1fr);gap:7px}.stress{border:1px solid var(--line);border-radius:10px;padding:9px;background:#121212}.stress b{font-size:9px;display:block}.stress span{font-size:9px;color:var(--muted);display:block;margin-top:5px}.mini-chart{height:145px;padding:0 13px 12px}.mini-chart canvas{width:100%;height:100%;display:block}.profile-row{display:grid;grid-template-columns:repeat(3,1fr);gap:7px;padding:13px 13px 0}.strategy-list,.diag-list{max-height:300px;overflow:auto}.strategy-row,.diag-row{display:grid;grid-template-columns:110px 1fr 62px;gap:8px;align-items:center;padding:9px 12px;border-bottom:1px solid rgba(32,49,40,.58);font-size:9px}.diag-row{grid-template-columns:130px 1fr}.strategy-row .bar{height:6px}.journal-actions{display:flex;gap:6px}.tag{display:inline-block;padding:3px 6px;border-radius:99px;background:#172119;color:#a8bdaf;font-size:8px;margin:1px}.quality-strip{height:7px;border-radius:99px;background:#1a241d;overflow:hidden;margin-top:7px}.quality-strip span{display:block;height:100%;background:linear-gradient(90deg,var(--r),var(--a),var(--g));border-radius:99px}.inline-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:7px}.modal textarea{width:100%;min-height:130px;resize:vertical;padding:12px;border-radius:10px;border:1px solid var(--line);background:#0d0d0d;color:var(--text);outline:none}.build-chip{font-size:8px;color:var(--muted);margin-top:5px}.pulse-live{animation:livepulse 1.4s ease-in-out infinite}@keyframes livepulse{50%{opacity:.55}}@media(max-width:900px){.intel-grid{grid-template-columns:repeat(3,1fr)}.stress-list{grid-template-columns:1fr}.profile-row{grid-template-columns:1fr}}@media(max-width:680px){.intel-grid{grid-template-columns:repeat(2,1fr)}.strategy-row{grid-template-columns:90px 1fr 50px}.inline-grid{grid-template-columns:1fr}}.infinity-shell{margin-top:12px}.infinity-grid{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:8px;padding:13px}.infinity-tile{border:1px solid var(--line);background:#0f0f0f;border-radius:11px;padding:11px;min-height:85px}.infinity-tile b{display:block;font-size:15px;margin:7px 0 4px}.infinity-tile span{font-size:8px;color:var(--muted);line-height:1.4}.lab-toolbar{display:flex;gap:7px;flex-wrap:wrap}.lab-output{margin:0 13px 13px;min-height:180px;max-height:540px;overflow:auto;border:1px solid var(--line);background:#080808;border-radius:11px;padding:12px;font:9px/1.55 ui-monospace,SFMono-Regular,Menlo,monospace;color:#b8cbbd;white-space:pre-wrap}.alert-form,.note-form{display:grid;grid-template-columns:repeat(5,1fr);gap:7px;padding:13px}.note-form{grid-template-columns:90px 1fr 2fr 1fr auto}.alert-form input,.alert-form select,.note-form input{min-width:0;width:100%;background:#0d0d0d;color:var(--text);border:1px solid var(--line);border-radius:9px;padding:9px}.infinity-list{max-height:260px;overflow:auto}.infinity-row{display:grid;grid-template-columns:90px 1fr auto;gap:8px;padding:10px 13px;border-bottom:1px solid rgba(32,49,40,.6);font-size:9px;align-items:center}.infinity-row span{color:var(--muted)}@media(max-width:900px){.infinity-grid{grid-template-columns:repeat(2,1fr)}.alert-form,.note-form{grid-template-columns:1fr 1fr}}@media(max-width:600px){.infinity-grid,.alert-form,.note-form{grid-template-columns:1fr}}.agent-shell{margin-top:12px}.agent-hero{display:grid;grid-template-columns:1.25fr .75fr;gap:10px;padding:13px}.agent-orbit{min-height:245px;border:1px solid var(--line);border-radius:14px;background:radial-gradient(circle at center,rgba(117,255,157,.13),transparent 35%),#0d0d0d;position:relative;overflow:hidden;display:grid;place-items:center}.agent-core{width:104px;height:104px;border-radius:50%;display:grid;place-items:center;background:radial-gradient(circle at 35% 30%,#ddffe5,#65ff94 26%,#0a3b1c 60%,#07100a 74%);box-shadow:0 0 60px rgba(117,255,157,.35);position:relative;z-index:2}.agent-core b{font-size:22px;color:#07100a}.agent-ring{position:absolute;border:1px solid rgba(117,255,157,.2);border-radius:50%;animation:agentSpin linear infinite}.agent-ring.r1{width:160px;height:160px;animation-duration:12s}.agent-ring.r2{width:215px;height:215px;animation-duration:18s;animation-direction:reverse}.agent-ring.r3{width:285px;height:285px;animation-duration:26s}.agent-ring:after{content:"";position:absolute;width:8px;height:8px;border-radius:50%;background:var(--g);box-shadow:0 0 14px var(--g);top:-4px;left:50%}@keyframes agentSpin{to{transform:rotate(360deg)}}.agent-summary{display:grid;grid-template-columns:repeat(2,1fr);gap:8px;align-content:start}.agent-stat{border:1px solid var(--line);border-radius:11px;padding:11px;background:#0f0f0f}.agent-stat b{font-size:18px;display:block;margin-top:6px}.agent-controls{display:grid;grid-template-columns:repeat(5,1fr);gap:8px;padding:0 13px 13px}.agent-controls input{width:100%;border:1px solid var(--line);border-radius:9px;background:#0d0d0d;color:var(--text);padding:9px}.agent-desk-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:8px;padding:13px}.agent-desk{border:1px solid var(--line);border-radius:11px;background:#0f0f0f;padding:11px;min-height:120px}.agent-desk.live{border-color:#3c6b49;box-shadow:inset 0 0 20px rgba(117,255,157,.035)}.agent-desk h4{font-size:10px;margin:0 0 5px}.agent-desk p{font-size:8px;line-height:1.45;color:var(--muted);min-height:34px}.agent-votes{display:flex;gap:5px;font-size:8px;margin:8px 0}.agent-votes span{background:#1b1b1b;border-radius:6px;padding:4px 5px}.agent-progress{height:6px;border-radius:99px;background:#18221b;overflow:hidden}.agent-progress i{height:100%;display:block;background:linear-gradient(90deg,var(--b),var(--g));border-radius:99px}.agent-run-list{max-height:270px;overflow:auto}.user-chip{display:flex;align-items:center;gap:8px;border:1px solid var(--line);border-radius:999px;padding:7px 10px;color:var(--muted);font-size:9px}.user-avatar{width:22px;height:22px;border-radius:50%;display:grid;place-items:center;background:var(--g);color:#07100a;font-weight:900}.auth-note{font-size:8px;color:var(--muted)}@media(max-width:900px){.agent-hero{grid-template-columns:1fr}.agent-controls{grid-template-columns:1fr 1fr}.agent-desk-grid{grid-template-columns:repeat(2,1fr)}}@media(max-width:600px){.agent-controls,.agent-desk-grid{grid-template-columns:1fr}.user-chip span{display:none}}.modal{position:fixed;inset:0;z-index:100;background:rgba(0,0,0,.76);display:none;place-items:center;padding:18px;backdrop-filter:blur(12px)}.modal.show{display:grid}.modal-card{width:min(540px,100%);background:#111111;border:1px solid #31443a;border-radius:18px;box-shadow:0 40px 120px #000;padding:20px}.modal-card h3{margin:0 0 6px}.modal-card p{font-size:10px;line-height:1.55;color:var(--muted)}.modal-grid{display:grid;gap:9px;margin:15px 0}.modal input{width:100%;border:1px solid var(--line);border-radius:10px;background:#0d0d0d;color:var(--text);padding:11px;outline:none}.modal-actions{display:flex;justify-content:flex-end;gap:8px}.toast{position:fixed;right:21px;bottom:21px;z-index:150;border:1px solid #365241;background:#171717;border-radius:12px;padding:12px 14px;max-width:380px;font-size:10px;box-shadow:var(--shadow);transform:translateY(18px);opacity:0;pointer-events:none;transition:.25s}.toast.show{transform:none;opacity:1}.toast.err{border-color:#67323a;color:#ffb7bd}.mobile-nav{display:none}.role-chip{font-size:8px;letter-spacing:.8px;color:var(--g);border:1px solid var(--line);padding:4px 7px;border-radius:999px}.guardian-shell{margin-top:11px;overflow:hidden}.guardian-summary{display:grid;grid-template-columns:repeat(4,1fr);gap:8px;padding:13px}.guardian-stat{border:1px solid var(--line);background:#0f0f0f;border-radius:11px;padding:12px}.guardian-stat b{display:block;font-size:18px;margin-top:6px}.guardian-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:8px;padding:0 13px 13px}.guardian-check{border:1px solid var(--line);border-radius:10px;padding:10px;background:#0f0f0f}.guardian-check.pass{border-color:#28563a}.guardian-check.fail{border-color:#672c34}.guardian-check b{font-size:10px;display:block}.guardian-check span{font-size:8px;color:var(--muted);display:block;margin-top:5px;line-height:1.45}.security-actions{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:8px;padding:13px;border-top:1px solid var(--line)}.session-list{padding:0 13px 13px}.session-row{display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;border-bottom:1px solid var(--line);padding:9px;font-size:9px}.owner-restricted{opacity:.45!important;cursor:not-allowed!important}.analyst-banner{border:1px solid #5b481e;background:#1b150a;color:#d8c17d;border-radius:10px;padding:9px 12px;font-size:9px;margin-bottom:10px}@media(max-width:1180px){.metrics{grid-template-columns:repeat(3,1fr)}.app{grid-template-columns:82px 1fr}.sidebar{padding:22px 12px}.logo h1,.logo small,.nav span,.side-status{display:none}.logo{justify-content:center;padding-left:0;padding-right:0}.nav button{justify-content:center}.layout{grid-template-columns:1fr}}@media(max-width:720px){.app{display:block}.sidebar{display:none}main{padding:17px 11px 80px}.top{align-items:flex-start}.title h2{font-size:20px}.pill{display:none}.metrics{grid-template-columns:repeat(2,1fr);gap:7px}.metric{min-height:92px;padding:12px}.value{font-size:19px}.layout{display:block}.stack{margin-bottom:10px}.chart-card{min-height:330px}.chart-wrap{height:268px}.settings{grid-template-columns:1fr}.full{grid-column:auto}.backtest-grid{grid-template-columns:repeat(2,1fr)}.mobile-nav{display:flex;position:fixed;z-index:60;left:0;right:0;bottom:0;justify-content:space-around;background:rgba(7,11,8,.94);backdrop-filter:blur(14px);border-top:1px solid var(--line);padding:9px 8px calc(9px + env(safe-area-inset-bottom))}.mobile-nav button{border:0;background:transparent;color:var(--muted);font-size:8px}.mobile-nav b{display:block;font-size:15px;color:var(--text);margin-bottom:2px}}

/* NEXUS trading companion */
.nexus-shell{margin-bottom:11px;overflow:hidden;background:radial-gradient(circle at 28% 35%,rgba(61,181,255,.12),transparent 31%),linear-gradient(145deg,rgba(9,19,24,.97),rgba(5,10,12,.98));border-color:#21485c}.nexus-grid{display:grid;grid-template-columns:minmax(300px,.85fr) minmax(0,1.35fr);gap:12px;padding:13px}.nexus-stage{min-height:500px;border:1px solid #1c4d61;border-radius:16px;position:relative;overflow:hidden;display:grid;place-items:center;background:radial-gradient(circle at 50% 36%,rgba(80,205,255,.18),transparent 34%),linear-gradient(rgba(75,208,255,.035) 1px,transparent 1px),linear-gradient(90deg,rgba(75,208,255,.035) 1px,transparent 1px),#050b0e;background-size:auto,28px 28px,28px 28px}.nexus-stage:after{content:"";position:absolute;inset:0;background:linear-gradient(transparent 0,rgba(82,213,255,.06) 48%,transparent 52%);background-size:100% 8px;animation:nexusScan 7s linear infinite;pointer-events:none}.nexus-floor{position:absolute;left:12%;right:12%;bottom:26px;height:70px;border:1px solid rgba(83,210,255,.24);border-radius:50%;transform:perspective(180px) rotateX(66deg);box-shadow:0 0 40px rgba(76,200,255,.16),inset 0 0 35px rgba(76,200,255,.08)}@keyframes nexusScan{to{background-position:0 160px}}.nexus-avatar{position:relative;width:230px;height:390px;filter:drop-shadow(0 0 23px rgba(72,203,255,.25));transition:.35s;animation:nexusFloat 4.2s ease-in-out infinite}.nexus-avatar:before{content:"";position:absolute;inset:0;border-radius:48%;background:radial-gradient(circle at 50% 42%,rgba(94,224,255,.08),transparent 54%);animation:nexusAura 2.8s ease-in-out infinite}.nexus-head{position:absolute;left:78px;top:27px;width:74px;height:92px;border:2px solid #65dfff;border-radius:36px 36px 29px 29px;background:linear-gradient(145deg,rgba(93,218,255,.28),rgba(10,43,56,.75));box-shadow:inset 0 0 24px rgba(104,226,255,.18),0 0 24px rgba(74,204,255,.19);z-index:5}.nexus-face-line{position:absolute;left:12px;right:12px;top:51px;height:1px;background:rgba(123,232,255,.5)}.nexus-eye{position:absolute;top:34px;width:16px;height:5px;border-radius:99px;background:#bdf8ff;box-shadow:0 0 13px #6fe9ff}.nexus-eye.left{left:13px;transform:skewY(-7deg)}.nexus-eye.right{right:13px;transform:skewY(7deg)}.nexus-mouth{position:absolute;left:27px;right:27px;bottom:20px;height:2px;background:#6fdaed;box-shadow:0 0 5px #70e5ff;transition:.15s}.nexus-neck{position:absolute;top:111px;left:101px;width:29px;height:28px;border-left:2px solid #4ebbd7;border-right:2px solid #4ebbd7;background:rgba(22,78,95,.55);z-index:3}.nexus-torso{position:absolute;left:52px;top:133px;width:128px;height:151px;clip-path:polygon(20% 0,80% 0,100% 23%,84% 100%,16% 100%,0 23%);border:2px solid #55cce8;background:linear-gradient(150deg,rgba(82,205,237,.25),rgba(10,40,50,.78));box-shadow:inset 0 0 35px rgba(80,211,244,.14);z-index:3}.nexus-torso:before,.nexus-torso:after{content:"";position:absolute;top:22px;width:1px;height:105px;background:rgba(110,223,248,.35)}.nexus-torso:before{left:31px;transform:rotate(-8deg)}.nexus-torso:after{right:31px;transform:rotate(8deg)}.nexus-reactor{position:absolute;left:44px;top:38px;width:40px;height:40px;border:2px solid #b9f8ff;border-radius:50%;background:radial-gradient(circle,#e4fdff 0,#62e7ff 20%,#177f9e 42%,rgba(4,25,33,.8) 65%);box-shadow:0 0 24px #52dfff,0 0 55px rgba(82,223,255,.34);animation:reactorPulse 1.8s ease-in-out infinite}.nexus-arm{position:absolute;top:145px;width:36px;height:154px;border:2px solid #49bcd8;background:linear-gradient(rgba(69,180,208,.26),rgba(8,39,49,.78));border-radius:22px 22px 15px 15px;transform-origin:50% 12px}.nexus-arm.left{left:24px;transform:rotate(9deg)}.nexus-arm.right{right:23px;transform:rotate(-9deg)}.nexus-hand{position:absolute;left:6px;bottom:-22px;width:20px;height:29px;border:2px solid #55cae5;border-radius:9px 9px 13px 13px;background:rgba(18,68,82,.85)}.nexus-hip{position:absolute;left:76px;top:276px;width:79px;height:43px;clip-path:polygon(10% 0,90% 0,76% 100%,24% 100%);border:2px solid #48b8d3;background:rgba(18,66,80,.72);z-index:2}.nexus-leg{position:absolute;top:310px;width:39px;height:116px;border:2px solid #42acc8;background:linear-gradient(rgba(56,156,181,.23),rgba(7,32,40,.82));border-radius:16px 16px 12px 12px}.nexus-leg.left{left:69px;transform:rotate(2deg)}.nexus-leg.right{right:68px;transform:rotate(-2deg)}.nexus-leg:after{content:"";position:absolute;bottom:-10px;left:-5px;width:47px;height:19px;border:2px solid #45b5d0;border-radius:13px 18px 7px 7px;background:rgba(12,50,62,.9)}.nexus-status{position:absolute;left:15px;right:15px;bottom:13px;display:flex;justify-content:space-between;align-items:center;border:1px solid rgba(78,196,224,.24);border-radius:10px;background:rgba(3,12,16,.72);backdrop-filter:blur(10px);padding:9px 11px;font-size:9px;color:#9bd7e4;z-index:8}.nexus-status b{color:#c7f8ff;letter-spacing:1px}.nexus-avatar.listening .nexus-eye{animation:eyeListen .45s ease-in-out infinite alternate}.nexus-avatar.listening .nexus-reactor{animation:reactorListen .65s ease-in-out infinite}.nexus-avatar.thinking{animation:nexusThink 1.2s ease-in-out infinite}.nexus-avatar.speaking .nexus-mouth{height:8px;border-radius:50%;animation:mouthTalk .18s ease-in-out infinite alternate}.nexus-avatar.alert{filter:drop-shadow(0 0 26px rgba(255,75,91,.5))}.nexus-avatar.alert .nexus-eye,.nexus-avatar.alert .nexus-reactor{background:#ff6070;box-shadow:0 0 20px #ff5061}.nexus-console{display:grid;gap:10px;align-content:start}.nexus-header{display:flex;justify-content:space-between;gap:10px;align-items:flex-start;border:1px solid #1b4252;border-radius:13px;background:rgba(4,14,18,.7);padding:13px}.nexus-name h3{font-size:18px;letter-spacing:4px;margin:0;color:#bcefff}.nexus-name p{font-size:9px;color:#75a8b5;margin:5px 0 0}.nexus-runtime{display:flex;gap:7px;flex-wrap:wrap;justify-content:flex-end}.nexus-runtime span{font-size:8px;border:1px solid #245568;border-radius:999px;padding:5px 7px;color:#8ed4e5;background:#07151a}.nexus-metrics{display:grid;grid-template-columns:repeat(4,1fr);gap:7px}.nexus-metric{border:1px solid #193f4e;background:#071217;border-radius:10px;padding:10px}.nexus-metric b{display:block;font-size:15px;margin-top:5px;color:#bcefff}.nexus-transcript{min-height:185px;max-height:260px;overflow:auto;border:1px solid #1c4657;border-radius:12px;background:#040b0e;padding:11px}.nexus-line{display:grid;grid-template-columns:58px 1fr;gap:9px;padding:8px 0;border-bottom:1px solid rgba(54,116,137,.22);font-size:10px;line-height:1.45}.nexus-line:last-child{border-bottom:0}.nexus-line b{font-size:8px;letter-spacing:.9px;color:#61cce7}.nexus-line.user b{color:#91ffad}.nexus-command-row{display:grid;grid-template-columns:1fr auto auto;gap:7px}.nexus-command-row input{min-width:0;border:1px solid #255468;border-radius:11px;background:#050d11;color:#e9fbff;padding:12px;outline:none}.nexus-command-row input:focus{border-color:#5ed9f5;box-shadow:0 0 0 3px rgba(73,201,233,.08)}.nexus-mic{width:44px;height:44px;border-radius:50%;border:1px solid #3a7990;background:#0a2028;color:#a7efff;cursor:pointer;font-size:18px}.nexus-mic.live{background:#5fe5ff;color:#05202a;box-shadow:0 0 30px rgba(76,220,255,.45);animation:micPulse .75s ease-in-out infinite}.nexus-quick{display:flex;flex-wrap:wrap;gap:6px}.nexus-quick button{border:1px solid #214a5b;background:#07141a;color:#91ccda;border-radius:999px;padding:7px 9px;font-size:8px;cursor:pointer}.nexus-quick button:hover{color:#d6f8ff;border-color:#4da7c0}.nexus-settings{display:flex;align-items:center;justify-content:space-between;gap:10px;border:1px solid #183a47;border-radius:10px;padding:9px 11px;color:#78a8b4;font-size:9px}.nexus-settings label{display:flex;align-items:center;gap:7px}.nexus-safety{border:1px solid #5b481e;background:#171409;border-radius:10px;padding:10px;font-size:9px;line-height:1.5;color:#d7c179}.nexus-companion{position:fixed;right:18px;bottom:18px;z-index:70;width:88px;height:124px;border:1px solid rgba(84,211,241,.45);border-radius:44px 44px 18px 18px;background:linear-gradient(rgba(8,31,39,.93),rgba(3,12,16,.96));box-shadow:0 0 36px rgba(65,190,223,.18),0 22px 70px rgba(0,0,0,.58);cursor:pointer;display:grid;place-items:center;transition:.25s}.nexus-companion:hover{transform:translateY(-4px);border-color:#72def6}.nexus-mini-head{position:absolute;top:14px;width:38px;height:44px;border:1px solid #67d7ef;border-radius:18px 18px 14px 14px;background:rgba(35,113,134,.42)}.nexus-mini-head:before,.nexus-mini-head:after{content:"";position:absolute;top:18px;width:8px;height:3px;background:#b6f8ff;box-shadow:0 0 8px #76e9ff;border-radius:99px}.nexus-mini-head:before{left:7px}.nexus-mini-head:after{right:7px}.nexus-mini-body{position:absolute;top:59px;width:51px;height:48px;clip-path:polygon(20% 0,80% 0,100% 30%,78% 100%,22% 100%,0 30%);border:1px solid #55c6df;background:rgba(25,89,105,.5)}.nexus-mini-core{position:absolute;top:70px;width:18px;height:18px;border:1px solid #d4fbff;border-radius:50%;background:#5ae6ff;box-shadow:0 0 15px #5ae6ff}.nexus-companion small{position:absolute;bottom:5px;font-size:7px;letter-spacing:1px;color:#a0ddea}.nexus-companion.live{box-shadow:0 0 42px rgba(78,224,255,.5)}.toast{right:118px}.mobile-nav{scrollbar-width:none}.mobile-nav::-webkit-scrollbar{display:none}@keyframes nexusFloat{50%{transform:translateY(-7px)}}@keyframes nexusAura{50%{opacity:.45;transform:scale(1.05)}}@keyframes reactorPulse{50%{transform:scale(1.08);filter:brightness(1.2)}}@keyframes reactorListen{50%{transform:scale(1.24);box-shadow:0 0 45px #76edff}}@keyframes eyeListen{to{transform:scaleX(1.35)}}@keyframes nexusThink{50%{filter:drop-shadow(0 0 36px rgba(122,103,255,.46)) hue-rotate(36deg)}}@keyframes mouthTalk{to{height:2px}}@keyframes micPulse{50%{transform:scale(1.07)}}@media(max-width:960px){.nexus-grid{grid-template-columns:1fr}.nexus-stage{min-height:455px}.nexus-metrics{grid-template-columns:repeat(2,1fr)}}@media(max-width:720px){.toast{right:11px;bottom:198px}.mobile-nav{overflow-x:auto;justify-content:flex-start;gap:16px}.mobile-nav button{min-width:48px}.nexus-command-row{grid-template-columns:1fr auto}.nexus-command-row .btn{grid-column:1/-1}.nexus-companion{right:10px;bottom:67px;transform:scale(.82);transform-origin:right bottom}.nexus-stage{min-height:430px}.nexus-avatar{transform:scale(.9)}.nexus-runtime{justify-content:flex-start}.nexus-header{display:block}.nexus-runtime{margin-top:9px}}

/* NEXUS intelligence workspace */
.omni-shell{margin:11px 0;overflow:hidden;border-color:#35526f;background:radial-gradient(circle at 18% 18%,rgba(91,165,255,.13),transparent 30%),radial-gradient(circle at 82% 10%,rgba(175,104,255,.12),transparent 30%),linear-gradient(145deg,rgba(10,17,26,.97),rgba(6,10,15,.98))}.omni-hero{display:grid;grid-template-columns:290px 1fr;gap:14px;padding:15px}.omni-neural{min-height:255px;position:relative;border:1px solid #29445b;border-radius:16px;overflow:hidden;background:radial-gradient(circle at center,rgba(106,168,255,.16),transparent 36%),linear-gradient(rgba(110,180,255,.035) 1px,transparent 1px),linear-gradient(90deg,rgba(110,180,255,.035) 1px,transparent 1px),#060c12;background-size:auto,24px 24px,24px 24px;display:grid;place-items:center}.omni-neural:after{content:"";position:absolute;inset:-50%;background:conic-gradient(from 0deg,transparent,rgba(255,255,255,.035),rgba(111,168,255,.08),transparent 34%);animation:spin 18s linear infinite}.omni-core{position:relative;z-index:4;width:112px;height:112px;border:1px solid #8bd3ff;border-radius:50%;display:grid;place-items:center;background:radial-gradient(circle,#effcff 0,#6ed7ff 12%,#235d83 35%,#0a1b29 62%,rgba(4,9,14,.9) 70%);box-shadow:0 0 32px rgba(96,205,255,.45),0 0 95px rgba(114,103,255,.18);animation:omniPulse 2.8s ease-in-out infinite}.omni-core b{font-size:19px;letter-spacing:2px;color:#eafaff;text-shadow:0 0 12px #a9ebff}.omni-node{position:absolute;z-index:3;width:48px;height:48px;border:1px solid rgba(129,207,255,.55);border-radius:50%;display:grid;place-items:center;background:rgba(8,24,36,.88);font-size:8px;font-weight:900;color:#bfeeff;box-shadow:0 0 18px rgba(75,190,255,.12)}.omni-node:before{content:"";position:absolute;width:75px;height:1px;background:linear-gradient(90deg,rgba(121,210,255,.5),transparent);transform-origin:left center;left:24px;top:24px}.omni-node.n1{left:21px;top:34px}.omni-node.n1:before{transform:rotate(21deg)}.omni-node.n2{right:22px;top:35px}.omni-node.n2:before{left:auto;right:24px;transform-origin:right center;transform:rotate(-21deg)}.omni-node.n3{left:20px;bottom:33px}.omni-node.n3:before{transform:rotate(-22deg)}.omni-node.n4{right:20px;bottom:33px}.omni-node.n4:before{left:auto;right:24px;transform-origin:right center;transform:rotate(22deg)}.omni-node.n5{left:50%;top:15px;transform:translateX(-50%)}.omni-node.n5:before{width:54px;transform:rotate(90deg);left:24px;top:48px}.omni-node.n6{left:50%;bottom:15px;transform:translateX(-50%)}.omni-node.n6:before{width:54px;transform:rotate(-90deg);left:24px;top:0}@keyframes omniPulse{50%{transform:scale(1.04);box-shadow:0 0 50px rgba(96,205,255,.56),0 0 120px rgba(114,103,255,.23)}}.omni-summary{display:grid;grid-template-columns:repeat(3,1fr);gap:9px;align-content:start}.omni-stat{border:1px solid #253d51;border-radius:13px;padding:13px;background:rgba(7,16,23,.78);min-height:86px}.omni-stat b{display:block;font-size:21px;margin-top:9px;color:#d9f5ff}.omni-stat span:last-child{display:block;font-size:8px;color:#7994a4;margin-top:5px}.omni-autonomy{display:grid;grid-template-columns:repeat(4,1fr);gap:8px;padding:0 15px 15px}.autonomy-card{border:1px solid #263d50;background:#08121a;color:#8fa8b7;border-radius:12px;padding:11px;text-align:left;cursor:pointer}.autonomy-card b{display:block;color:#dff7ff;font-size:10px;margin-bottom:5px}.autonomy-card span{font-size:8px;line-height:1.35;display:block}.autonomy-card.active{border-color:#72d9ff;background:rgba(41,113,151,.22);box-shadow:0 0 24px rgba(76,195,255,.12)}.omni-toolbar{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px;padding:13px 15px;border-top:1px solid #20384b;border-bottom:1px solid #20384b}.omni-toolbar .btn{width:100%}.omni-workspace{display:grid;grid-template-columns:1fr 1fr;gap:11px;padding:14px}.omni-panel{border:1px solid #253d51;border-radius:14px;background:rgba(5,13,19,.75);overflow:hidden}.omni-panel h4{margin:0;padding:12px 13px;border-bottom:1px solid #20384b;font-size:10px;text-transform:uppercase;letter-spacing:1px}.omni-form{display:grid;grid-template-columns:1fr auto;gap:7px;padding:11px}.omni-form.triple{grid-template-columns:110px 1fr auto}.omni-form input,.omni-form select,.omni-form textarea{min-width:0;width:100%;border:1px solid #284052;border-radius:9px;background:#050c11;color:var(--text);padding:9px;outline:none}.omni-list{max-height:270px;overflow:auto}.omni-item{padding:10px 12px;border-bottom:1px solid rgba(38,61,80,.65);display:grid;gap:5px}.omni-item-head{display:flex;justify-content:space-between;gap:8px;align-items:center}.omni-item b{font-size:10px}.omni-item small{font-size:8px;color:#7f99a8;line-height:1.45}.omni-item-actions{display:flex;gap:5px;flex-wrap:wrap}.omni-item-actions button{border:1px solid #29445a;background:#0a1720;color:#b9ddec;border-radius:7px;padding:5px 7px;font-size:8px;cursor:pointer}.omni-debate{display:grid;grid-template-columns:repeat(5,minmax(120px,1fr));gap:8px;padding:11px;overflow:auto}.debater{border:1px solid #29445a;border-radius:11px;padding:10px;background:#07121a;min-height:155px}.debater b{font-size:9px;display:block;color:#c7efff}.debater em{display:block;font-style:normal;font-size:8px;color:#77b5d3;margin:5px 0}.debater p{font-size:8px;color:#91aab7;line-height:1.45;margin:4px 0}.twin-list{padding:10px 12px;display:grid;gap:8px}.twin-row{display:grid;grid-template-columns:45px 1fr 80px;gap:8px;align-items:center;font-size:8px}.twin-track{height:7px;background:#14232d;border-radius:99px;overflow:hidden}.twin-track span{height:100%;display:block;border-radius:99px;background:linear-gradient(90deg,#ff6d79,#ffc857,#f4f4f5)}.reputation-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:7px;padding:11px}.rep-card{border:1px solid #263f52;border-radius:10px;padding:9px;background:#071118}.rep-card b{font-size:9px;display:block}.rep-card small{font-size:7px;color:#7792a2}.rep-meter{height:5px;background:#14232d;border-radius:99px;margin-top:7px;overflow:hidden}.rep-meter span{height:100%;display:block;background:#6fcaff}.omni-output{margin:0;padding:13px;background:#03080c;color:#9fd0e8;min-height:150px;max-height:360px;overflow:auto;font-size:9px;line-height:1.55;white-space:pre-wrap}.omni-badge{display:inline-block;padding:4px 7px;border-radius:99px;background:rgba(103,190,255,.12);color:#a8e3ff;font-size:8px;font-weight:900}.omni-badge.warn{background:rgba(255,200,87,.12);color:#ffdc85}.omni-badge.danger{background:rgba(255,101,114,.12);color:#ff9da6}@media(max-width:1050px){.omni-hero{grid-template-columns:1fr}.omni-neural{min-height:235px}.omni-summary{grid-template-columns:repeat(3,1fr)}.omni-debate{grid-template-columns:repeat(3,minmax(150px,1fr))}}@media(max-width:700px){.omni-summary{grid-template-columns:repeat(2,1fr)}.omni-autonomy{grid-template-columns:repeat(2,1fr)}.omni-toolbar{grid-template-columns:repeat(2,1fr)}.omni-workspace{grid-template-columns:1fr}.reputation-grid{grid-template-columns:repeat(2,1fr)}.omni-debate{grid-template-columns:repeat(2,minmax(150px,1fr))}}


.expansion-shell{margin-top:12px;overflow:hidden}.expansion-summary{display:grid;grid-template-columns:repeat(4,1fr);gap:9px;padding:14px}.expansion-stat{border:1px solid var(--line);background:#0f0f0f;border-radius:12px;padding:12px}.expansion-stat b{display:block;font-size:20px;margin-top:7px}.expansion-tools{display:grid;grid-template-columns:1fr 180px 92px;gap:8px;padding:0 14px 14px}.expansion-tools input,.expansion-tools select{width:100%;border:1px solid var(--line);border-radius:9px;background:#0d0d0d;color:var(--text);padding:10px}.expansion-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;padding:0 14px 14px;max-height:520px;overflow:auto}.expansion-card{border:1px solid var(--line);background:#0a100c;border-radius:12px;padding:11px;cursor:pointer;transition:.18s}.expansion-card:hover{border-color:#436851;transform:translateY(-1px)}.expansion-card b{display:block;font-size:10px;line-height:1.35}.expansion-card span{display:block;font-size:8px;color:var(--muted);margin-top:6px}.expansion-card em{display:inline-block;margin-top:7px;font-style:normal;font-size:8px;color:var(--g)}.expansion-output{margin:0 14px 14px;min-height:180px;max-height:420px;overflow:auto;border:1px solid var(--line);border-radius:12px;background:#080808;padding:13px;color:#b7c8bc;font:10px/1.55 ui-monospace,SFMono-Regular,Menlo,monospace;white-space:pre-wrap}.expansion-runs{display:grid;gap:6px;padding:0 14px 14px}.expansion-run{display:grid;grid-template-columns:110px 1fr 90px;gap:8px;padding:8px 10px;border:1px solid var(--line);border-radius:9px;font-size:9px}.expansion-run span{color:var(--muted)}@media(max-width:1000px){.expansion-grid{grid-template-columns:repeat(2,1fr)}.expansion-summary{grid-template-columns:repeat(2,1fr)}}@media(max-width:680px){.expansion-grid{grid-template-columns:1fr}.expansion-tools{grid-template-columns:1fr}.expansion-summary{grid-template-columns:repeat(2,1fr)}}

/* NEXUS 11.1 MONOCHROME THEME */
:root{
  --bg:#070707!important;
  --panel:#101010!important;
  --panel2:#171717!important;
  --line:#2b2b2b!important;
...
.sidebar{background:rgba(8,8,8,.94)!important}
.card,.metric,.modal-card{background:linear-gradient(145deg,#141414,#0d0d0d)!important}
.btn.green{
...
<div class="card nexus-shell" id="nexus">
  <div class="panel-head"><div><h3>NEXUS Trading Command Core</h3><span>Deep voice · animated holographic body · trading-workspace control</span></div><div class="symbol-tools"><button class="btn blue" onclick="nexusBrief()">Speak briefing</button><button class="btn" onclick="toggleNEXUSVoice()" id="nexusVoiceBtn">Voice ON</button></div></div>
  <div class="nexus-grid">
    <div class="nexus-stage" id="nexusStage">
      <div class="nexus-floor"></div>
      <div class="nexus-avatar" id="nexusAvatar">
        <div class="nexus-head"><div class="nexus-eye left"></div><div class="nexus-eye right"></div><div class="nexus-face-line"></div><div class="nexus-mouth"></div></div>
        <div class="nexus-neck"></div>
        <div class="nexus-arm left"><div class="nexus-hand"></div></div><div class="nexus-arm right"><div class="nexus-hand"></div></div>
        <div class="nexus-torso"><div class="nexus-reactor"></div></div><div class="nexus-hip"></div>
        <div class="nexus-leg left"></div><div class="nexus-leg right"></div>
      </div>
      <div class="nexus-status"><b id="nexusMode">ONLINE · IDLE</b><span id="nexusListenStatus">Press the microphone or type a command</span></div>
    </div>
    <div class="nexus-console">
      <div class="nexus-header"><div class="nexus-name"><h3>J.A.R.V.I.S.</h3><p>Joint Agent Risk, Validation and Intelligence System · trading scope only</p></div><div class="nexus-runtime"><span id="nexusScope">TRADING ONLY</span><span id="nexusVoiceState">DEEP VOICE ON</span><span id="nexusMicSupport">MIC CHECKING</span></div></div>
      <div class="nexus-metrics"><div class="nexus-metric"><span class="label">Agents</span><b id="nexusAgents">—</b></div><div class="nexus-metric"><span class="label">Active</span><b id="nexusActive">—</b></div><div class="nexus-metric"><span class="label">Positions</span><b id="nexusPositions">—</b></div><div class="nexus-metric"><span class="label">Execution</span><b id="nexusExecution">—</b></div></div>
      <div class="nexus-transcript" id="nexusTranscript"><div class="nexus-line"><b>NEXUS</b><span>Command core ready. I can control this trading workspace, but I cannot access unrelated files, applications, passwords, or unrestricted computer functions.</span></div></div>
      <div class="nexus-command-row"><input id="nexusCommand" placeholder="Try: NEXUS, scan the market" autocomplete="off"><button class="nexus-mic" id="nexusMic" onclick="toggleNEXUSListening()" title="Voice command">◉</button><button class="btn green" id="nexusSend" onclick="sendNEXUSCommand()">Send command</button></div>
      <div class="nexus-quick"><button onclick="nexusQuick('NEXUS, give me a status report')">Status report</button><button onclick="nexusQuick('NEXUS, scan the market')">Scan market</button><button onclick="nexusQuick('NEXUS, analyze AAPL')">Analyze AAPL</button><button onclick="nexusQuick('NEXUS, how many agents are active?')">Agent status</button><button onclick="nexusQuick('NEXUS, read my portfolio')">Portfolio</button><button onclick="nexusQuick('NEXUS, open risk controls')">Open risk</button><button onclick="nexusQuick('NEXUS, emergency stop')">Emergency stop</button></div>
      <div class="nexus-settings"><label><input type="checkbox" id="nexusAutoSpeak" checked onchange="saveNEXUSPreferences()"> Speak every response</label><label><input type="checkbox" id="nexusConfirmSpeech" checked onchange="saveNEXUSPreferences()"> Read safety confirmations</label><span>Voice availability depends on the browser and installed system voices.</span></div>
      <div class="nexus-safety"><b>Safety boundary:</b> NEXUS can navigate and operate this trading website, run analysis, read reports, stop automation, and activate emergency protection. It cannot control unrelated parts of the computer. Any command that could open or enlarge a paper position requires an exact typed confirmation and a second risk-engine check.</div>
    </div>
  </div>
</div>
...
<div class="card omni-shell" id="omni">
  <div class="panel-head"><div><h3>NEXUS Intelligence Center</h3><span>Memory · adversarial reasoning · missions · digital twin · time machine · safe autonomy</span></div><div class="lab-toolbar"><select id="omniPersona" data-owner-only onchange="setOmniPersona()" class="symbol-input" style="width:112px"><option>SENTINEL</option><option>ANALYST</option><option>TACTICIAN</option><option>SKEPTIC</option></select><button class="btn blue" onclick="loadOmni()">Synchronize mind</button><button class="btn" onclick="nexusQuick('NEXUS, what do you remember?')">Ask memory</button><button class="btn green" onclick="nexusQuick('NEXUS, debate '+selected)">Voice debate</button></div></div>
  <div class="omni-hero">
  ...
  <div class="omni-workspace">
    ...
    <div class="omni-panel" style="grid-column:1/-1"><h4>Decision DNA and Cognitive Output</h4><pre class="omni-output" id="omniOutput">NEXUS Intelligence is ready. Choose a research operation. Research actions cannot place an order.</pre></div>
  </div>
</div>
...
<nav class="mobile-nav"><button onclick="navTo('overview')"><b>⌂</b>Home</button><button onclick="navTo('scanner')"><b>⌁</b>Radar</button><button onclick="navTo('backtest')"><b>⌗</b>Test</button><button onclick="navTo('intelligence')"><b>◇</b>Risk</button><button onclick="navTo('positions')"><b>▥</b>Portfolio</button><button onclick="navTo('risk')"><b>⚙</b>Risk</button><button onclick="navTo('nexus')"><b>◉</b>NEXUS</button><button onclick="navTo('omni')"><b>◈</b>OMNI</button><button onclick="navTo('agents')"><b>◎</b>Agents</button><button onclick="navTo('infinityLab')"><b>∞</b>Lab</button><button onclick="navTo('expansionMatrix')"><b>＋</b>363</button><button onclick="navTo('guardianCenter')"><b>◆</b>Guard</button></nav>

<div class="nexus-companion" id="nexusCompanion" onclick="nexusCompanionClick()" title="Open NEXUS command core"><div class="nexus-mini-head"></div><div class="nexus-mini-body"></div><div class="nexus-mini-core"></div><small>NEXUS</small></div>

<div class="modal" id="plansModal"><div class="modal-card"><h3>Plans</h3><p>Free is active now. Premium and Elite are displayed for launch positioning but payments remain disabled until a verified legal payment account is connected.</p><div class="modal-grid"><div class="warning"><b>FREE — $0</b><br>24 logical agents, research workspace and typed NEXUS commands.<br><span class="positive">AVAILABLE NOW</span></div><div class="warning"><b>PREMIUM — $29/month</b><br>1,000 agents, deep-voice NEXUS and expanded paper-trading research.<br><span class="amberText">COMING SOON</span></div><div class="warning"><b>ELITE — $99/month</b><br>5,000 agents, full OMNI labs, digital twin and maximum fleet controls.<br><span class="amberText">COMING SOON</span></div></div><div class="modal-actions"><button class="btn green" onclick="closeModal('plansModal')">Done</button></div></div></div>
...
<script>
let DATA=null,selected='AAPL',latest=null,chartBars=[],currentBacktest=null,NEXUS=null,OMNI=null,EXPANSION=null,nexusRecognition=null,nexusListening=false,nexusVoices=[],nexusTranscriptHistory=[];
const CSRF='__CSRF__';
...
function nexusPreferences(){return {voice:safeStorageGet('nexusNEXUSVoice','1')!=='0',autoSpeak:safeStorageGet('nexusNEXUSAutoSpeak','1')!=='0',confirmSpeech:safeStorageGet('nexusNEXUSConfirmSpeech','1')!=='0'}}
function saveNEXUSPreferences(){safeStorageSet('nexusNEXUSAutoSpeak',$('nexusAutoSpeak').checked?'1':'0');safeStorageSet('nexusNEXUSConfirmSpeech',$('nexusConfirmSpeech').checked?'1':'0');renderNEXUSVoiceState()}
function renderNEXUSVoiceState(){const p=nexusPreferences();if($('nexusAutoSpeak'))$('nexusAutoSpeak').checked=p.autoSpeak;if($('nexusConfirmSpeech'))$('nexusConfirmSpeech').checked=p.confirmSpeech;setText('nexusVoiceBtn',p.voice?'Voice ON':'Voice OFF');setText('nexusVoiceState',p.voice?'DEEP VOICE ON':'VOICE MUTED')}
function toggleNEXUSVoice(){const next=nexusPreferences().voice?'0':'1';safeStorageSet('nexusNEXUSVoice',next);if(next==='0'&&'speechSynthesis'in window)speechSynthesis.cancel();renderNEXUSVoiceState();toast(next==='1'?'NEXUS voice enabled':'NEXUS voice muted')}
function loadNEXUSVoices(){if(!('speechSynthesis'in window))return;nexusVoices=speechSynthesis.getVoices()||[]}
function deepNEXUSVoice(){loadNEXUSVoices();const prefs=['Microsoft David','Microsoft Mark','Daniel','Alex','Google UK English Male','Google US English','Fred','Ralph'];for(const name of prefs){const v=nexusVoices.find(x=>x.name.toLowerCase().includes(name.toLowerCase()));if(v)return v}return nexusVoices.find(v=>/^en/i.test(v.lang)&&/(male|david|daniel|alex|mark|fred|ralph)/i.test(v.name))||nexusVoices.find(v=>/^en-GB/i.test(v.lang))||nexusVoices.find(v=>/^en/i.test(v.lang))||nexusVoices[0]||null}
function nexusMode(mode,detail=''){const avatar=$('nexusAvatar'),companion=$('nexusCompanion');if(avatar)avatar.className='nexus-avatar '+String(mode||'idle').toLowerCase();if(companion)companion.classList.toggle('live',['listening','thinking','speaking'].includes(String(mode).toLowerCase()));setText('nexusMode',`ONLINE · ${String(mode||'IDLE').toUpperCase()}`);if(detail)setText('nexusListenStatus',detail)}
function nexusLine(who,text){const transcript=$('nexusTranscript');if(!transcript)return;const line=document.createElement('div');line.className='nexus-line '+(who==='YOU'?'user':'');const b=document.createElement('b');b.textContent=who;const span=document.createElement('span');span.textContent=text;line.append(b,span);transcript.appendChild(line);while(transcript.children.length>18)transcript.firstElementChild.remove();transcript.scrollTop=transcript.scrollHeight;nexusTranscriptHistory.push({who,text,ts:new Date().toISOString()});if(nexusTranscriptHistory.length>50)nexusTranscriptHistory.shift()}
function speakNEXUS(text,force=false){const p=nexusPreferences();if(!p.voice||(!p.autoSpeak&&!force)||!('speechSynthesis'in window)||!text)return;try{speechSynthesis.cancel();const u=new SpeechSynthesisUtterance(String(text).slice(0,1400));const v=deepNEXUSVoice();if(v)u.voice=v;u.lang=v?.lang||'en-US';u.pitch=.55;u.rate=.88;u.volume=1;u.onstart=()=>nexusMode('speaking','Speaking');u.onend=()=>nexusMode('idle','Command core ready');u.onerror=()=>nexusMode('idle','Voice playback unavailable');speechSynthesis.speak(u)}catch(e){nexusMode('idle','Voice playback unavailable')}}
async function loadNEXUS(speak=false){try{NEXUS=await api('/api/nexus');renderNEXUS();if(speak)speakNEXUS(NEXUS.brief?.speech||'',true)}catch(e){toast(e.message,true);nexusMode('alert','NEXUS connection error')}}
function renderNEXUS(){if(!NEXUS)return;const b=NEXUS.brief||{},r=NEXUS.runtime||{};setText('nexusAgents',num(b.agents,0));setText('nexusActive',num(b.active_agents,0));setText('nexusPositions',num(b.positions,0));setText('nexusExecution',b.kill_switch?'STOPPED':b.execution_armed?'ARMED':'LOCKED');setText('nexusScope',NEXUS.scope?.toUpperCase()||'TRADING ONLY');if(r.last_response&&!nexusTranscriptHistory.some(x=>x.text===r.last_response))nexusLine('NEXUS',r.last_response);renderNEXUSVoiceState();const SpeechRecognition=window.SpeechRecognition||window.webkitSpeechRecognition;setText('nexusMicSupport',SpeechRecognition?'MIC READY':'TYPE MODE');nexusMode(r.mode||'idle',r.last_command_at?`Last command ${shortTime(r.last_command_at)}`:'Command core ready')}
async function nexusBrief(){await loadNEXUS(false);if(NEXUS?.brief?.speech){nexusLine('NEXUS',NEXUS.brief.speech);speakNEXUS(NEXUS.brief.speech,true)}}
function nexusQuick(command){$('nexusCommand').value=command;sendNEXUSCommand()}
function nexusCompanionClick(){navTo('nexus');setTimeout(()=>{$('nexusCommand')?.focus()},450)}
function toggleNEXUSListening(){const SpeechRecognition=window.SpeechRecognition||window.webkitSpeechRecognition;if(!SpeechRecognition){toast('Voice recognition is unavailable in this browser. Type the command instead.',true);$('nexusCommand')?.focus();return}if(nexusListening&&nexusRecognition){nexusRecognition.stop();return}try{nexusRecognition=new SpeechRecognition();nexusRecognition.lang='en-US';nexusRecognition.interimResults=true;nexusRecognition.continuous=false;nexusRecognition.maxAlternatives=1;nexusRecognition.onstart=()=>{nexusListening=true;$('nexusMic').classList.add('live');nexusMode('listening','Listening for a trading command')};nexusRecognition.onresult=e=>{let interim='',finalText='';for(let i=e.resultIndex;i<e.results.length;i++){const t=e.results[i][0].transcript;if(e.results[i].isFinal)finalText+=t;else interim+=t}$('nexusCommand').value=finalText||interim;if(finalText){nexusRecognition.stop();setTimeout(()=>sendNEXUSCommand(finalText),120)}};nexusRecognition.onerror=e=>{nexusListening=false;$('nexusMic').classList.remove('live');nexusMode('idle',e.error==='not-allowed'?'Microphone permission denied':'Voice recognition stopped');if(e.error!=='aborted')toast(`Microphone: ${e.error}`,true)};nexusRecognition.onend=()=>{nexusListening=false;$('nexusMic').classList.remove('live');if(!$('nexusAvatar')?.classList.contains('thinking'))nexusMode('idle','Command core ready')};nexusRecognition.start()}catch(e){toast('Could not start microphone recognition',true);nexusMode('idle','Type a command instead')}}
async function handleNEXUSConfirmation(result){if(!result.requires_confirmation)return true;const typed=prompt(result.confirmation_prompt||`Type ${result.confirmation_phrase} to confirm.`,'');if(typed===null){nexusLine('NEXUS','Command cancelled.');speakNEXUS('Command cancelled.',nexusPreferences().confirmSpeech);return false}if(typed.trim().toUpperCase()!==String(result.confirmation_phrase||'').toUpperCase()){nexusLine('NEXUS','Confirmation did not match. No action was taken.');speakNEXUS('Confirmation did not match. No action was taken.',nexusPreferences().confirmSpeech);return false}nexusMode('thinking','Running final risk checks');try{await api(result.endpoint,{method:'POST',body:JSON.stringify(result.payload||{})});nexusLine('NEXUS','Confirmation accepted. The command completed after server-side checks.');speakNEXUS('Confirmation accepted. The command completed after server-side checks.',nexusPreferences().confirmSpeech);await refresh();await loadNEXUS();return true}catch(e){nexusLine('NEXUS',`Command blocked: ${e.message}`);speakNEXUS(`Command blocked. ${e.message}`,true);toast(e.message,true);return false}}
async function performNEXUSAction(result){if(result.navigate)navTo(result.navigate);if(result.requires_confirmation){await handleNEXUSConfirmation(result);return}switch(result.client_action){case'navigate':break;case'fullscreen':if(!document.fullscreenElement)await document.documentElement.requestFullscreen?.();break;case'exit_fullscreen':if(document.fullscreenElement)await document.exitFullscreen?.();break;case'export':await exportData();break;case'refresh':await refresh(true);break;case'mute':safeStorageSet('nexusNEXUSVoice','0');renderNEXUSVoiceState();if('speechSynthesis'in window)speechSynthesis.cancel();break;case'unmute':safeStorageSet('nexusNEXUSVoice','1');renderNEXUSVoiceState();break;case'logout':await logout();return}if(result.refresh){await refresh();await loadAgents();await loadNEXUS()}}
async function sendNEXUSCommand(provided){const input=$('nexusCommand');const command=String(provided||input?.value||'').trim();if(!command)return toast('Type or speak a NEXUS command',true);if(input)input.value='';nexusLine('YOU',command);nexusMode('thinking','Understanding command and checking permissions');$('nexusSend').disabled=true;try{const result=await api('/api/nexus-command',{method:'POST',body:JSON.stringify({command})});nexusLine('NEXUS',result.speech||'Command complete.');speakNEXUS(result.speech||'Command complete.',result.requires_confirmation?nexusPreferences().confirmSpeech:false);await performNEXUSAction(result)}catch(e){nexusLine('NEXUS',`I could not complete that command: ${e.message}`);speakNEXUS(`I could not complete that command. ${e.message}`,true);toast(e.message,true);nexusMode('alert','Command blocked')}finally{$('nexusSend').disabled=false;if(!$('nexusAvatar')?.classList.contains('speaking'))nexusMode('idle','Command core ready')}}
...
async function setOmniPersona(){try{const persona=$('omniPersona').value;const r=await api('/api/omni-persona',{method:'POST',body:JSON.stringify({persona})});toast(`NEXUS persona: ${r.persona}`);await loadOmni()}catch(e){toast(e.message,true)}}
async function setOmniAutonomy(level){const current=Number(OMNI?.profile?.autonomy?.level||0);let confirm='';if(level>current){confirm=prompt(`Raising NEXUS permissions requires exact confirmation. Type SET AUTONOMY ${level}`,'')||'';if(confirm!==`SET AUTONOMY ${level}`)return toast('Autonomy change cancelled',true)}try{const r=await api('/api/omni-autonomy',{method:'POST',body:JSON.stringify({level,confirm})});toast(`NEXUS autonomy: ${r.autonomy.name}`);await refresh();await loadOmni()}catch(e){toast(e.message,true)}}
async function saveOmniMemory(){const content=$('omniMemoryText').value.trim();if(!content)return toast('Enter something for NEXUS to remember',true);try{await api('/api/omni-memory',{method:'POST',body:JSON.stringify({content,symbol:$('omniMemorySymbol').value.trim(),kind:'OPERATOR',importance:7})});$('omniMemoryText').value='';toast('Stored in private NEXUS memory');await loadOmni()}catch(e){toast(e.message,true)}}
async function deleteOmniMemory(id){if(!confirm('Remove this NEXUS memory?'))return;try{await api('/api/omni-memory',{method:'POST',body:JSON.stringify({action:'delete',id})});await loadOmni()}catch(e){toast(e.message,true)}}
async function runOmniDebate(){const symbol=String($('symbol').value||selected||'AAPL').toUpperCase();try{nexusMode('thinking',`Converging adversarial board for ${symbol}`);const r=await api('/api/omni-debate',{method:'POST',body:JSON.stringify({symbol})});renderOmniDebate(r.debate);omniShow(r.debate,`ADVERSARIAL BOARD · ${symbol}`);speakNEXUS(`The adversarial board returns ${r.debate.verdict} for ${symbol}, with ${r.debate.disagreement.toFixed(1)} percent disagreement.`);await loadOmni()}catch(e){toast(e.message,true)}finally{nexusMode('idle','NEXUS intelligence ready')}}
async function runOmniPremortem(){const symbol=String($('symbol').value||selected||'AAPL').toUpperCase();try{const r=await api('/api/omni-premortem',{method:'POST',body:JSON.stringify({symbol})});omniShow(r.report,`PRE-MORTEM · ${symbol}`);speakNEXUS(`Pre-mortem complete. I found ${r.report.failure_modes.length} failure modes.`)}catch(e){toast(e.message,true)}}
async function runOmniTwin(){const shock=Number($('omniShock').value||-10);try{const r=await api('/api/omni-twin',{method:'POST',body:JSON.stringify({shock_pct:shock})});renderOmniTwin(r.twin);omniShow(r.twin,`DIGITAL TWIN · ${shock}% SHOCK`);speakNEXUS(`Digital twin complete. Estimated portfolio change is ${money(r.twin.pnl)}.`)}catch(e){toast(e.message,true)}}
...
async function executeOmniMission(id){try{nexusMode('thinking','Executing bounded research mission');const r=await api('/api/omni-mission',{method:'POST',body:JSON.stringify({action:'execute',id})});omniShow(r.mission,`MISSION · ${r.mission.mission_type}`);toast(`Mission ${r.mission.status.toLowerCase()}`);await refresh();await loadOmni()}catch(e){toast(e.message,true)}finally{nexusMode('idle','Mission control ready')}}
...
window.addEventListener('keydown',e=>{if(e.key==='Escape')document.querySelectorAll('.modal.show').forEach(x=>x.classList.remove('show'));if(['INPUT','TEXTAREA'].includes(document.activeElement?.tagName))return;if(e.key==='/'){e.preventDefault();$('symbol').focus();$('symbol').select()}else if(e.key.toLowerCase()==='j'){e.preventDefault();navTo('nexus');setTimeout(()=>$('nexusCommand')?.focus(),350)}else if(e.key.toLowerCase()==='v'){e.preventDefault();toggleNEXUSListening()}else if(e.key.toLowerCase()==='a')analyzeOne();else if(e.key.toLowerCase()==='s')scanAll()});
...
window.addEventListener('load',async()=>{setText('userAvatar',('__USER__'||'U').slice(0,1).toUpperCase());loadNEXUSVoices();if('speechSynthesis'in window)speechSynthesis.onvoiceschanged=loadNEXUSVoices;renderNEXUSVoiceState();$('nexusCommand')?.addEventListener('keydown',e=>{if(e.key==='Enter'){e.preventDefault();sendNEXUSCommand()}});await refresh();await loadChart();await loadInfinity();await loadExpansion();await loadSecurity();await loadAgents();await loadNEXUS();await loadOmni();setInterval(()=>refresh(),15000);setInterval(()=>loadAgents(),5000);setInterval(()=>loadNEXUS(),10000);setInterval(()=>loadOmni(),20000);setInterval(()=>loadInfinity(),60000);setInterval(()=>loadExpansion(),120000)});
</script></body></html>'''



AUTH_HTML = r'''<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>NEXUS OMNI NEXUS · Sign in</title><style>
:root{--bg:#070707;--panel:#111111;--line:#303030;--text:#f5f5f5;--muted:#a1a1aa;--g:#f4f4f5;--r:#ff6572}*{box-sizing:border-box}body{margin:0;min-height:100vh;display:grid;place-items:center;padding:20px;color:var(--text);font-family:Inter,system-ui,sans-serif;background:radial-gradient(circle at 75% 0,rgba(255,255,255,.13),transparent 34%),radial-gradient(circle at 0 90%,rgba(80,120,255,.1),transparent 30%),var(--bg)}.shell{width:min(980px,100%);display:grid;grid-template-columns:1.05fr .95fr;border:1px solid var(--line);border-radius:24px;overflow:hidden;background:rgba(10,15,12,.94);box-shadow:0 40px 140px #000}.hero{padding:44px;background:radial-gradient(circle at center,rgba(117,255,157,.10),transparent 45%)}.mark{width:52px;height:52px;border-radius:16px;border:1px solid var(--g);display:grid;place-items:center;color:var(--g);font-weight:950;box-shadow:0 0 36px rgba(117,255,157,.2)}h1{font-size:38px;line-height:1.02;letter-spacing:-1.7px;margin:34px 0 15px}p{color:var(--muted);line-height:1.6;font-size:13px}.facts{display:grid;grid-template-columns:repeat(2,1fr);gap:9px;margin-top:28px}.fact{border:1px solid var(--line);border-radius:12px;padding:12px;background:rgba(5,8,6,.55)}.fact b{font-size:18px;display:block}.fact span{font-size:9px;color:var(--muted)}.panel{padding:38px;background:#101010}.tabs{display:flex;gap:6px;margin-bottom:22px}.tabs button{flex:1;border:1px solid var(--line);border-radius:10px;background:#121212;color:var(--muted);padding:10px;font-weight:800;cursor:pointer}.tabs button.active{background:var(--g);color:#07100a;border-color:var(--g)}form{display:grid;gap:11px}.field label{display:block;font-size:9px;color:var(--muted);text-transform:uppercase;letter-spacing:1px;margin-bottom:6px}.field input{width:100%;padding:12px;border-radius:10px;border:1px solid var(--line);background:#060a07;color:var(--text);outline:none}.field input:focus{border-color:#4d7d5c}.submit{border:0;border-radius:10px;background:var(--g);color:#061008;padding:12px;font-weight:900;cursor:pointer;margin-top:4px}.msg{min-height:18px;color:var(--r);font-size:10px}.small{font-size:9px;color:var(--muted);line-height:1.5}.signup-only{display:none}body.signup .signup-only{display:block}@media(max-width:760px){.shell{grid-template-columns:1fr}.hero{padding:28px}.panel{padding:28px}h1{font-size:30px}.facts{display:none}}
